...
#[doc = " \\brief Pinned CUDA GPU device by cudaMallocHost"]
...
fn bindgen_test_layout_DLContext() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<DLContext>())).device_type as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(DLContext),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<DLContext>())).device_id as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(DLContext),
...
pub struct DLTensor {
    ...
    #[doc = " \\brief The device context of the tensor"]
    pub ctx: DLContext,
...
fn bindgen_test_layout_DLTensor() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<DLTensor>())).ctx as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(DLTensor),
